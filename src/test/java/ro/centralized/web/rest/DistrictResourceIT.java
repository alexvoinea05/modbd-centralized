...
import ro.centralized.repository.DistrictRepository;
import ro.centralized.service.dto.DistrictDTO;
import ro.centralized.service.mapper.DistrictMapper;
...
class DistrictResourceIT {
    ...
    public static District createEntity(EntityManager em) {
        District district = new District().name(DEFAULT_NAME).region(DEFAULT_REGION);
        return district;
    }
    ...
    public static District createUpdatedEntity(EntityManager em) {
        District district = new District().name(UPDATED_NAME).region(UPDATED_REGION);
        return district;
    }
    ...
    void createDistrict() throws Exception {
        ...
        assertThat(testDistrict.getRegion()).isEqualTo(DEFAULT_REGION);
    }
    ...
    void putExistingDistrict() throws Exception {
        ...
        updatedDistrict.name(UPDATED_NAME).region(UPDATED_REGION);
        ...
        assertThat(testDistrict.getRegion()).isEqualTo(UPDATED_REGION);
    }
    ...
    void partialUpdateDistrictWithPatch() throws Exception {
        ...
        partialUpdatedDistrict.name(UPDATED_NAME).region(UPDATED_REGION);

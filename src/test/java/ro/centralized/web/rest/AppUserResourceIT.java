...
import ro.centralized.repository.AppUserRepository;
import ro.centralized.service.dto.AppUserDTO;
import ro.centralized.service.mapper.AppUserMapper;
...
class AppUserResourceIT {
    ...
    void createAppUser() throws Exception {
        ...
        assertThat(testAppUser.getCnp()).isEqualTo(DEFAULT_CNP);
    }
    ...
    void putExistingAppUser() throws Exception {
        ...
        assertThat(testAppUser.getCnp()).isEqualTo(UPDATED_CNP);
    }
    ...
    void partialUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.email(UPDATED_EMAIL).password(UPDATED_PASSWORD).firstName(UPDATED_FIRST_NAME).cnp(UPDATED_CNP);

...
import ro.centralized.repository.RailwayStationRepository;
import ro.centralized.service.RailwayStationService;
...
/**
 * REST controller for managing {@link ro.centralized.domain.RailwayStation}.
 */
@RestController
@RequestMapping("/api")

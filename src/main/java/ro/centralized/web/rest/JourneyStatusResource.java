...
import ro.centralized.repository.JourneyStatusRepository;
import ro.centralized.service.JourneyStatusService;
...
/**
 * REST controller for managing {@link ro.centralized.domain.JourneyStatus}.
 */
@RestController
@RequestMapping("/api")

...
import ro.centralized.repository.TrainRepository;
import ro.centralized.service.TrainService;
...
/**
 * REST controller for managing {@link ro.centralized.domain.Train}.
 */
@RestController
@RequestMapping("/api")

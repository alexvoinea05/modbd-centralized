...
import ro.centralized.repository.UserTypeRepository;
import ro.centralized.service.UserTypeService;
...
/**
 * REST controller for managing {@link ro.centralized.domain.UserType}.
 */
@RestController
@RequestMapping("/api")

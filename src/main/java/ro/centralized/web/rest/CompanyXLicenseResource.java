...
import ro.centralized.repository.CompanyXLicenseRepository;
import ro.centralized.service.CompanyXLicenseService;
...
/**
 * REST controller for managing {@link ro.centralized.domain.CompanyXLicense}.
 */
@RestController
@RequestMapping("/api")

...
import ro.centralized.repository.RailwayTypeRepository;
import ro.centralized.service.RailwayTypeService;
...
/**
 * REST controller for managing {@link ro.centralized.domain.RailwayType}.
 */
@RestController
@RequestMapping("/api")

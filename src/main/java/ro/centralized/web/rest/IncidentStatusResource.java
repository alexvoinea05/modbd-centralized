...
import ro.centralized.repository.IncidentStatusRepository;
import ro.centralized.service.IncidentStatusService;
...
/**
 * REST controller for managing {@link ro.centralized.domain.IncidentStatus}.
 */
@RestController
@RequestMapping("/api")

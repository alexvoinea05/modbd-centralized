...
import ro.centralized.repository.JourneyRepository;
import ro.centralized.service.JourneyService;
...
/**
 * REST controller for managing {@link ro.centralized.domain.Journey}.
 */
@RestController
@RequestMapping("/api")

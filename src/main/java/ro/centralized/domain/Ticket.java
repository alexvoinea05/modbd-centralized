...
public class Ticket implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "user", "tickets", "idUserType" }, allowSetters = true)
    private AppUser idAppUser;

    @ManyToOne
    @JsonIgnoreProperties(
        value = { "tickets", "idJourneyStatus", "idTrain", "idCompany", "idRailwayStationDeparture", "idRailwayStationArrival" },
        allowSetters = true
    )
